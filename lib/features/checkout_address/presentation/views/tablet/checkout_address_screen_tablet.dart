...
import 'package:tech_store/features/cart/presentation/widgets/external/cart_checkout_tablet.dart';
...
import 'package:tech_store/features/checkout_address/presentation/widgets/tablet/proceed_tablet.dart';
import 'package:tech_store/shared/widgets/app_bar.dart';
import 'package:tech_store/shared/widgets/help_and_support.dart';
class CheckoutAddressScreenTablet extends ConsumerWidget {
  const CheckoutAddressScreenTablet({super.key});
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        ProceedTablet(
                          number: 2,
                          chosen: 1,
                          desc: ['Shipping Address','Payment Method'],
                        ),
                      ],
                    ),
                  ),
