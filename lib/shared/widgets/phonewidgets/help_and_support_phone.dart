...
class HelpAndSupportPhone extends ConsumerWidget {
  const HelpAndSupportPhone({super.key});
    ...
    return Container(
     ...
     child: Column(
       ...
       children: [
         ...
         SizedBox(height: 24,),
         SvgPicture.asset('assets/icons/copyrights.svg'),
         SizedBox(height: 24,),
         Padding(
           padding: const EdgeInsets.only(bottom: 20),
           child: Center(
             child: SvgPicture.asset('assets/icons/paymentmethodes.svg'),
           ),
         )
       ],
